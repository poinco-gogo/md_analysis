...
ComputeKDE::ComputeKDE(vector<double>* ptr_dataVector1,	vector<double>* ptr_dataVector2, double min1, double max1, int nbin1, double band_width1, double min2, double max2, int nbin2, double band_width2)
{
	this->ptr_dataVector1    = ptr_dataVector1;
	this->ptr_dataVector2    = ptr_dataVector2;
